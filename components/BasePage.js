...
const BasePage = props => {
  ...
  const {
    ...
    className = '',
    header,
    title = "Portfolio - Kristian Ivancevic",
    metaDescription = "My name is Kristian Ivancevic and I am an front end and freelance developer. I'm a self-tought front end developer looking forward to learn new skills! At this point I've learned HTML,CSS, basic JS, React.js, Next.js and have a basic understanding of mongoDB, node.js and auth0.",
    canonicalPath,
    children } = props;
